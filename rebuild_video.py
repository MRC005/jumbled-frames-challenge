...
frame_sequence = np.load('frame_sequence.npy').astype(int)

# REVERSE the sequence to get forward motion
# (Based on our testing, the reversed order produces correct forward motion)
frame_sequence = frame_sequence[::-1]

print(f"Frame sequence (first 10): {frame_sequence[:10]}")
print(f"Frame sequence (last 10): {frame_sequence[-10:]}")
